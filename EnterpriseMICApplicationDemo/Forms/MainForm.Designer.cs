namespace EnterpriseMICApplicationDemo {
  partial class MainForm {
    ...
    private void InitializeComponent() {
		...
		this.bottomTableLayoutPanel.Paint += new System.Windows.Forms.PaintEventHandler(this.tableLayoutPanel1_Paint);
		// 
		// messageLabel
		// 
		...
		this.newIdeaTextBox.Indent = EnterpriseMICApplicationDemo.OpacityTextBox.ControlIndent.None;
