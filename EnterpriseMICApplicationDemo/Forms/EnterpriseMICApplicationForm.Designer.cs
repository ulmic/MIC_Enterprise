namespace EnterpriseMICApplicationDemo {
  partial class EnterpriseMICApplicationMiniForm {
    /// <summary>
    ...
    private void InitializeComponent() {
      this.SuspendLayout();
      // 
      // EnterpriseMICApplicationMiniForm
      // 
      ...
      this.Name = "EnterpriseMICApplicationMiniForm";
      this.Text = "EnterpriseMICApplicationMiniForm";
