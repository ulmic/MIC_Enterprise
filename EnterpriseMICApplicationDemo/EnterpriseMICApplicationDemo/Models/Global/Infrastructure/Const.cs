...
namespace EnterpriseMICApplicationDemo.Models.Global.Infrastructure
{
    ...
    public class Const
    {
        ...
        public struct AppMainFunctions
        {
        ...
        {
            /// <summary>
            /// Имеет пользователь функцию
            /// </summary>
            public const bool GOT = true;
            /// <summary>
            /// Не имеет пользователь функцию
            /// </summary>
        ...
        {   
            ...
            public const int ATTRIBUTES_FIRST_INDEX = 1;
            public const int ATTRIBUTES_MAX_INDEX = 26;
