...
namespace EnterpriseMICApplicationDemo {
  class DBHelper {
    ...
    /// <summary>
    /// Возвращает лист стрингов
    /// </summary>
    /// <param name="local">Место, из которого нужно получить людей</param>
    /// <returns></returns>
    ...
    /// <summary>
    /// Возвращает лист мест (local из БД)
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Возвращает экземпляр класса Member
    /// </summary>
    /// <param name="id">Id человека из базы</param>
    /// <returns></returns>
